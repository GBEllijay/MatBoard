...
2. **Pop-out Display + HDMI**  
   On a laptop, open the Controller (or keep it in a window), tap **Display** to open `/match` in a second window, fullscreen that window (`F11` or the browser fullscreen control), and send it to the TV with HDMI or “Cast tab”.
