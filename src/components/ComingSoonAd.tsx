  ...
  return (
    <figure className="soon-ad__preview">
      <img
        ...
        alt="Advantage Pro console home with Media Console, In-House Tournament Management Suite, Competitor Management System, and Instructor Collaboration and Cloud Access"
        width={816}
        height={1400}
      />
      <figcaption>
